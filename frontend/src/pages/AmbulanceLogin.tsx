    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            if (data.authorized) {
                ...
                navigate('/ambulance'); // Redirect to portal
            } else {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
            <div className="bg-white max-w-md w-full rounded-2xl shadow-xl border border-slate-100 p-8 text-center">
                ...
                <h1 className="text-2xl font-bold text-slate-900 mb-2">Ambulance Login</h1>
                <p className="text-slate-500 mb-8">Authorized personnel only.</p>
